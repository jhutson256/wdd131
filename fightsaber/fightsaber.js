const lightsabers = [
    {
        ...
        tags: ["light", "blue", "jedi", "color", "guardian"],
    ...
    },
    {
        ...
        tags: ["light", "green", "jedi", "color", "consular"],
    ...
    },
    {
        ...
        tags: ["light", "yellow", "jedi", "color", "sentinel", "temple", "guards"],
    ...
    },
    {
        ...
        tags: ["hilt", "lightsaber", "curved", "dooku", "ahsoka", "ventress"],
    ...
    },
    {
        ...
        tags: ["hilt", "lightsaber", "crossguard", "vented", "vent", "Kylo", "Ren"],
    ...
    },
    {
        ...
        tags: ["hilt", "lightsaber", "staff", "maul", "double", "bladed"],
...
function search() {
    ...
    let filteredLore = lightsabers.filter(function(lore) {
        return (
            ...
            lore.tags.find(tag=> tag.toLowerCase().includes(loreQuery.toLowerCase()))
        );
    });
    ...
    let relevantLore = filteredLore.map(function(lore) {
        ...
        else if (lore.tags.find(tag=> tag.toLowerCase().includes(loreQuery.toLowerCase()))) {
            relevancePoints += 7;
        }
